...
// TODO: Should be able to create instances by name.
// https://stackoverflow.com/a/39636265/1463
let logglyInstance;
const getLoggly = (serviceName) => {
  if (!logglyInstance) {
    logglyInstance = loggly(serviceName);
  }
...
class Logger {
  constructor(serviceName, logName) {
    ...
    this.loggly = getLoggly(serviceName);
    this.timers = {};
    this.time = (label) => {
