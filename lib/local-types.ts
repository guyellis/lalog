...
export type ParseReqOut = Pick<
  ParseReqIn,
  'body' | 'headers' | 'method' | 'params' | 'path' | 'query' | 'url' | 'user'
>;
...
export type LogFunction = (logData: LogData, response?: ResponseWrapper) => Promise<void>;
